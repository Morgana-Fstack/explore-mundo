      ...
      <div className="bg-white shadow-2xl rounded-lg overflow-hidden p-6 md:p-8">
        ...
        <div className="space-y-4 text-stone-700 leading-relaxed text-lg">
          <div className="p-4 bg-stone-50 rounded-lg">
            <p>
              <strong>Criado por:</strong> Morgana Petterle da Cunha
            </p>
            <p>
              <strong>Localização:</strong> Curitiba, Paraná
            </p>
          </div>
          <div className="pt-4 mt-4 border-t border-stone-200">
            ...
            <p>
              Este aplicativo foi criado como forma de trabalho prático para a
              disciplina:
            </p>
            ...
            <p className="mt-4">
              A versão atual foi construída com React, TypeScript e Vite, com
              foco em responsividade e experiência de navegação.
            </p>
          </div>
        </div>
      </div>
